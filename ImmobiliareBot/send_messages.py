"""
Invio messaggi su immobiliare.it
...
from platforms.immobiliare import Immobiliare
from core.engine import run_campaign


def main():
    parser = argparse.ArgumentParser(description="Invio messaggi su immobiliare.it")
    ...
    run_campaign(Immobiliare(), SCRIPT_DIR, args)
